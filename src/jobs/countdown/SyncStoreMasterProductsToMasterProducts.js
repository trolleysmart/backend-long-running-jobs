...
const jobName = 'Countdown - Sync Store Master Products to Master Products';
...
Parse.Cloud.job(jobName, async (request, status) => {
  ...
  try {
    await service.syncStoreMasterProductsToMasterProducts(global.parseServerSessionToken);

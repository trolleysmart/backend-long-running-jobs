...
var CountdownService = function CountdownService(_ref) {
  ...
  this.updateStoreCralwerProductCategoriesConfiguration = function (config) {
    var self = _this;
  ...
  this.syncToTagList = function (config) {
    var self = _this;
  ...
  this.syncMasterProductTags = function (config) {
    var self = _this;
...
CountdownService.getConfig = function () {
  return new Promise(function (resolve, reject) {
...
CountdownService.getCountdownStore = function () {
  return new Promise(function (resolve, reject) {
...
CountdownService.getExistingTags = function () {
  return new Promise(function (resolve, reject) {

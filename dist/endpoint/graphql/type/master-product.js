...
exports.masterProductsField = exports.masterProductType = exports.tagType = undefined;
...
var masterProductType = new _graphql.GraphQLObjectType({
  name: 'MasterProduct',
  fields: function fields() {
    return {
      id: {
...
var masterProductsField = {
  type: new _graphql.GraphQLList(masterProductType),
  args: {
    description: {
      type: _graphql.GraphQLString
    }
...
exports.masterProductType = masterProductType;
exports.masterProductsField = masterProductsField;